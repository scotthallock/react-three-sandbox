const ControlPanelButtons = ({
  ...
  <div className="relative flex items-center justify-end gap-[6px] w-[260px] min-h-[24px] px-[10px]">
    ...
    <button className="fill-gray-400 hover:fill-emerald-500" onClick={toggleMinimize}>
    ...
    <div className="flex items-center justify-center absolute h-[24px] w-[100px] left-1/2 transform -translate-x-1/2">
      <input
        className="truncate text-center bg-transparent outline-none"
        type="text"
        value={name}
